...
export interface SoftTriggerRuntimeStatus {
  workspace:string; camera:string; enabled:boolean; armed:boolean; pixel_count:number; active_ratio:number; roi_pixels:number; fires:number; last_fire_sequence:number; last_error:string;
}
