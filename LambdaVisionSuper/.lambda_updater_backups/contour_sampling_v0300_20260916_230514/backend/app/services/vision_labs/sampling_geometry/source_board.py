    ...
    *,
    ...
    entries = [
        ...
        _entry(
            "geometry_raster",
            geometry_raster,
            label="Geometry Raster",
            origin=(
                f"geometry source {geometry_upstream['service_id']}:{geometry_upstream['output_name']}"
                if geometry_upstream
                else "raw input"
            ),
        ),
    ...
    manifest = {
        ...
        "upstream": {
            "image_service": image_upstream,
            "geometry_service": geometry_upstream,
        },
        "entries": entries,
        "geometry_contour_count": len(master_contours.contours),
    }
