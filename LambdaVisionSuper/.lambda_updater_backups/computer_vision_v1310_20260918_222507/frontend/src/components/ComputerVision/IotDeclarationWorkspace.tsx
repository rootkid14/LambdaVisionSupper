...
export const IotDeclarationWorkspace=({config,onChange}:Props)=>{
 ...
 return <div className="flex h-full min-h-0 flex-col bg-[#17191d] text-[#e8eaed]">
  <div className="flex h-11 items-center gap-3 border-b border-[#34363a] bg-[#22252a] px-4">
   <Wifi size={15} className="text-[#65d1ff]"/><div><div className="text-[10px] font-black tracking-[.14em]">IOT DECLARATION ENGINE</div><div className="text-[7px] text-[#8b949e]">Declare hardware objects once. Automation IDE receives them as typed live endpoints.</div></div>
