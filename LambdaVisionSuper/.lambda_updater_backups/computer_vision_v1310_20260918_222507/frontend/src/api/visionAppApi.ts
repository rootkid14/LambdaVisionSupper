...
export interface AutomationEndpoint {
  ...
  description:string; source:string; example:string; last_value:any; allowed_values:any[]; unit:string; object_type:string;
}
...
export interface AutomationSystemState {
  program_id:string; scheduler_running:boolean; online:boolean; active_workspace:string; last_workspace:string; workspace_results:Record<string,string>; run_state:'IDLE'|'CAPTURING'|'INSPECTING'|'DECIDING'|'FINISHED'|'ERROR';
...
export interface WorkspaceDefinition {
  workspace_id:string; name:string; alias:string; enabled:boolean; input_binding:string;
