...
BUNDLE_DEFINITIONS = {
    ...
    "Computer Vision Program": {
        "purpose": "Production Computer Vision application with v0.13.5 declared resources and strictly isolated multi-Workspace control plane: IOT + Camera Declaration Engines, one-camera-per-workspace binding, dynamic typed Endpoint Registry, colored Automation IDE/IntelliSense, Online/Offline scheduler, VisionRunSnapshot, per-workspace Master/ROI/Working state, Filter→Logic execution and lazy Debug Stack.",
        "minimal": (
