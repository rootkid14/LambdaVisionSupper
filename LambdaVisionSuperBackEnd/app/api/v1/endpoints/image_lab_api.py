...
import cv2
import numpy as np
from fastapi import Request, APIRouter, File, HTTPException, UploadFile, WebSocket, WebSocketDisconnect
...
@router.post("/sessions/{session_id}/input/{source_name}", summary="Upload raw image bytes into session RAM")
