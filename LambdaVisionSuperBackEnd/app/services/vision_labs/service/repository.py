...
class LabServiceRepository:
    ...
    def _allocate_service_id(self, name: str) -> str:
        base = _slugify(name)
        candidate = base
        suffix = 2
        while (self.root / candidate / "active.json").exists():
    ...
    def deploy(
        ...
        *,
        ...
        # Omitting service_id means "deploy a new independent service".
        # Supplying service_id means "publish a new version of this service".
        resolved_id = service_id or self._allocate_service_id(name)
