...
This script uses:
    ...
    engineer_mlp_v1.py
    best.pt checkpoint produced by train_engineer_mlp_1108.py

No command-line arguments are used. Edit the CONFIG section below.

Important
---------
- The model was trained on 1108D features created from IMAGE + VALID MASK.
  Therefore using the real valid mask at inference is strongly recommended.
- GT masks are NOT required for inference.
- Raw features are standardized with mean/std stored inside the checkpoint.
"""
...
CHECKPOINT_PATH = Path(
    "/home/hieu/Desktop/Nidec Vision/run/engineer_mlp_1108_v1/checkpoints/best.pt"
)
...
OUTPUT_DIR = Path("/home/hieu/Desktop/Nidec Vision/run/engineer_mlp_1108_v1/test_run")
