...
class ESPCameraOutput_test(BaseModel):
...
# ==========================================
@registry_node
class VoThaovaChongHieu(BaseNode[None, ESPCameraOutput_test]):
    INPUT_SCHEMA = None
    OUTPUT_SCHEMA = ESPCameraOutput_test
    NODE_TYPE = NodeType.OBJECT

    METHOD_NODE_LIST = ['MakeNumberNode'] #Currently does not have any related method nodes
    
    # Dữ liệu hiển thị trên FE
    UI_LABEL = "Vo Hieu Va chong Thao"
    UI_DESCRIPTION = "Test thử load pluggin"
